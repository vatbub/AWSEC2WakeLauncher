...
public class ClientTest extends TomcatTest {
    ...
    public void basicAsyncTest() throws Exception {
        ...
        AtomicReference<Client.IpInfo> ipInfo2 = new AtomicReference<>();

        Thread thread = client.launchInstance("i-45678765", (exception, ipInfo) -> {
            e[0] = exception;
            ipInfo2.set(ipInfo);
        });
        ...
        Assert.assertNotNull(ipInfo2.get());
    }
